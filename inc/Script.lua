...
if MsgText[1] == "رتبتيييييييييي" then return '❏ ** رتبتك هنا 𖣄 ←  ( '..msg.TheRank..' )\n' end
...
elseif Text== "رتبتيييييييييي" then return sendMsg(msg.chat_id_,msg.id_,"مفكر نفسه اركان حرب ")
...
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[نعم عزيزي المطور](https://t.me/U440p) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[نعم عزيزي المنشئ](https://t.me/U440p)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[نعم عزيزي المدير](https://t.me/U440p)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[نعم عزيزي الادمن](https://t.me/U440p)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[نعم عزيزي العضو](https://t.me/U440p)")
end 
end 
