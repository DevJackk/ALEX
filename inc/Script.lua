...
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[نعم حبيبي المطور 🥺❤](https://t.me/U440p) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[نعم حبيبي المنشئ 🥺❤](https://t.me/U440p)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[نعم حبيبي المدير 🥺❤](https://t.me/U440p)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[نعم حبيبي الادمن 🥺❤](https://t.me/U440p)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[نعم حبيبي العضو 🥺❤️](https://t.me/U440p)")
end 
end 
