...
var =  'مرات اليكس'
elseif  UserID == 1702918704 then
var =  'ملك التيليجرام'
elseif  UserID == 13660554671366055467 then
var =  'المبرمج باندا'
...
elseif UserID == 1702918704 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك حظر ملك التيليجرام\n") 
elseif UserID == 13660554671366055467 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك حظر المبرمج باندا\n") 
elseif UserID == 1646796547 then 
...
elseif UserID == 1702918704 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك كتم ملك التيليجرام\n") 
elseif UserID == 13660554671366055467 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك كتم المبرمج باندا\n") 
elseif UserID == 1646796547 then 
...
elseif UserID == 1702918704 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد ملك التيليجرام\n") 
elseif UserID == 13660554671366055467 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد المبرمج باندا\n") 
elseif UserID == 1646796547 then 
...
elseif UserID == 1702918704 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك تقييد ملك التيليجرام\n") 
elseif UserID == 13660554671366055467 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك تقييد المبرمج باندا\n") 
elseif UserID == 1646796547 then 
...
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1506445642 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد مرات اليكسn") 
elseif UserID == 1702918704 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد ملك التيليجرام\n") 
elseif UserID == 13660554671366055467 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد المبرمج باندا\n")
...
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1506445642 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك مرات اليكس\n")  
elseif UserID == 1702918704 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد ملك التيليجرام\n") 
elseif UserID == 13660554671366055467 then 
return sendMsg(ChatID,MsgID,"❏ **لا يمكنك طرد المبرمج باندا\n") 
